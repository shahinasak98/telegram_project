    ...
    async def handle_text_message(message: types.Message):
        ...
        if message.text == "/start":
            ...
            if not await sync_to_async(chat.exists)():
                await sync_to_async(TelegramUser.objects.create)(chat_id=chat_id)
            ...
            await bot.send_message(chat_id=chat_id,text="Thanks for texting, Shahina will let you know what to do. Give a /start message for options of Jokes.Select any.")
